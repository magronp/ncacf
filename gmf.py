...
def train_main_gmf(in_out_list, variant_list, params, range_lW, range_lH, data_dir='data/'):
    ...
    for in_out in in_out_list:
        ...
        path_current = 'outputs/' + in_out + '/gmf/'
...
def test_main_gmf(in_out_list, variant_list, params, data_dir='data/'):
